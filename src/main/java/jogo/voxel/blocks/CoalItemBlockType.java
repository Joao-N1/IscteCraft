...
public class CoalItemBlockType extends VoxelBlockType {
        public CoalItemBlockType() { super("coal_item"); }
        ...
        public Material getMaterial(AssetManager am) {
            ...
            Texture2D tex = (Texture2D) am.loadTexture("Materials/CoalOre.png");
